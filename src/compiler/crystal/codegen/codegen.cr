...
module Crystal
  ...
  class Program
    ...
    def offset_of(type, element_index)
      case type
      when .extern_union?, StaticArrayInstanceType, VectorInstanceType
        0_u64
      else
    ...
    def instance_offset_of(type, element_index)
      # extern unions, static arrays, and vectors must be value types, which
      # always use the above `offset_of` instead
